...
// JONJ
    Renderer.prototype.blockquoteError = function (quote) {
        return '<blockquote class="error">\n' + quote + '</blockquote>\n';
    };

    Renderer.prototype.blockquoteWarning = function (quote) {
        return '<blockquote class="warning">\n' + quote + '</blockquote>\n';
    };

    Renderer.prototype.blockquoteInfo = function (quote) {
            ...
            case 'blockquote_error_start':
                {
                    ...
                    return this.renderer.blockquoteError(body);
                }

            case 'blockquote_warning_start':
                {
                    var body = '';
                    ...
                    return this.renderer.blockquoteWarning(body);
                }

            case 'blockquote_info_start':
                {
                    var body = '';
                    ...
                    return this.renderer.blockquoteInfo(body);
                  }
// ---- JONJ
            case 'list_start':
                {
